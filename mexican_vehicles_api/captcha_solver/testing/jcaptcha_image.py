...
class JCaptchaImage:
        ...
        for x in range(self.width):
            for y in range(self.height):
                ...
                if (
                    ...
                    or self.pixels[x - 1, y - 1] == (255, 255, 0)
                    or self.pixels[x - 1, y + 1] == (255, 255, 0)
                ) and (
                    self.pixels[x + 1, y] == (255, 255, 0)
                    or self.pixels[x + 1, y + 1] == (255, 255, 0)
                ...
                if self.pixels[x, y - 1] == (255, 255, 0) and self.pixels[x, y + 1] == (
                    255,
                    255,
                    0,
                ):
    ...
    def collect_character_imageList(self):
        ...
        while c < self.width - 1:
            ...
            bg = Image.open(f"{CURRENT_PATH}/mexican_vehicles_api/captcha_solver/testing/bg.jpg")
